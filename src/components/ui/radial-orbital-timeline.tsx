...
export default function RadialOrbitalTimeline({
  ...
  return (
    <div
      className="w-full min-h-[500px] md:min-h-[600px] flex flex-col items-center justify-center bg-transparent overflow-hidden"
      ref={containerRef}
    ...
    >
      <div className="relative w-full max-w-4xl h-[500px] md:h-[600px] flex items-center justify-center">
        ...
        >
          {/* Central Core */}
          <div className="absolute w-16 h-16 rounded-full bg-gradient-to-br from-primary via-primary/80 to-primary/40 animate-pulse flex items-center justify-center z-10 shadow-[0_0_30px_rgba(var(--primary),0.3)]">
            <div className="absolute w-20 h-20 rounded-full border border-primary/30 animate-ping opacity-60"></div>
            <div
              className="absolute w-24 h-24 rounded-full border border-primary/20 animate-ping opacity-40"
          ...
          {timelineData.map((item, index) => {
            ...
            return (
              ...
              >
                {/* Glow behind node */}
                <div
                  className={`absolute rounded-full -inset-4 blur-xl transition-opacity duration-500 ${
                    isExpanded || isRelated ? "opacity-30" : "opacity-0"
                  }`}
                  style={{
                ...
                <div
                  ...
                  ${isExpanded ? "scale-150" : "hover:scale-110 hover:border-primary"}
                `}
                >
                  <Icon size={18} />
                </div>
                ...
                <div
                  ...
                  text-[11px] md:text-xs font-bold tracking-tight
                  transition-all duration-300
                  ${isExpanded ? "text-primary scale-110" : "text-foreground/90 dark:text-foreground"}
                `}
                  style={{
                ...
                {isExpanded && (
                  <Card className="absolute top-24 left-1/2 -translate-x-1/2 w-64 bg-card/95 backdrop-blur-xl border-primary/30 shadow-2xl overflow-visible z-[300]">
