        ...
        <section id="projects" className="relative w-full overflow-hidden py-24 px-4">
            ...
            <div className="relative max-w-7xl mx-auto w-full space-y-12">
                ...
                <div className="flex justify-center pt-8">
                    <Link
                        href="/projects"
                        className="group relative inline-flex items-center gap-2 px-8 py-4 bg-foreground/5 border border-border rounded-full text-foreground font-bold hover:bg-primary hover:text-primary-foreground hover:border-primary transition-all duration-300 active:scale-95 overflow-hidden"
                    >
