...
export function ParticleTextEffect({ words = DEFAULT_WORDS }: ParticleTextEffectProps) {
    ...
    useEffect(() => {
        ...
        const animate = () => {
            ...
            // Background with motion trail — use site navy color
            ctx.fillStyle = "rgba(11, 18, 43, 0.18)"
        ...
        // Pre-fill with site background color to avoid black flash
        const initCtx = canvas.getContext("2d")!
        initCtx.fillStyle = "rgb(11, 18, 43)"
